...
void PanneauMatrice::mettreAJour(ModeAffiche etat) {
    switch (etat) {
        case MODE_NORMAL:  _afficherSmiley();   break;
        case MODE_RABAIS:  _defilerSpecial();   break;
        case MODE_ERREUR:  _clignoterErreur();  break;
        case MODE_FERMER:                       break;  // tout éteint
        case MODE_URGENCE: _afficherCroix();    break;
    }
}
